...
def get_params():
    ...
    parser.add_argument("--is_cuda", default=False, help="is cuda", type=bool)
    ...
    parser.add_argument("--scheduled_sampling", default=True, help="LAMBDA", type=bool)
    ...
    parser.add_argument('--max_grad_norm', default=2, help='for gradient clipping', type=float)
    ...
    parser.add_argument("--test_seg_x_dir", default=test_x_seg_path, help="test_seg_x_dir", type=str)
    ...
    parser.add_argument("--use_coverage", default=True, help="use_coverage", type=bool)
    ...
    parser.add_argument("--test_data_path", default=test_data_path, help="test_seg_x_dir", type=str)
